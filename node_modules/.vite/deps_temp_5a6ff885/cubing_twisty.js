...
// node_modules/cubing/dist/lib/cubing/chunks/chunk-C6NCOBGN.js
...
var _currentClassName, _a;
var ClassListManager = (_a = class {
...
}, _currentClassName = new WeakMap(), _a);
...
var CatchUpHelper = class {
  ...
  constructor(model) {
    ...
    __publicField(this, "tempoScale", 1);
...
var _TwistyAnimationController_instances, effectiveTimestampMilliseconds_fn, _animFrameEffectiveTimestampStaleDropper, _a2;
var TwistyAnimationController = (_a2 = class {
...
}, _animFrameEffectiveTimestampStaleDropper = new WeakMap(), _a2);
...
var _cachedPosition, _freshListenerManager, _a3;
var Twisty2DPuzzle = (_a3 = class extends ManagedCustomElement {
  ...
  onPositionChange(position) {
    ...
    try {
      if (position.movesInProgress.length > 0) {
        ...
        (_a17 = this.svgWrapper) == null ? void 0 : _a17.draw(
          position.pattern,
          newPattern,
          position.movesInProgress[0].fraction
        );
      } else {
        (_b = this.svgWrapper) == null ? void 0 : _b.draw(position.pattern);
      ...
      console.warn(
        ...
        (_c = this.puzzleLoader) == null ? void 0 : _c.id,
        e
      );
      this.disconnect();
    }
...
}, _cachedPosition = new WeakMap(), _freshListenerManager = new WeakMap(), _a3);
customElementsShim.define("twisty-2d-puzzle", Twisty2DPuzzle);
var _freshListenerManager2, _cachedTwisty2DPuzzle, _a4;
var Twisty2DPuzzleWrapper = (_a4 = class {
...
}, _freshListenerManager2 = new WeakMap(), _cachedTwisty2DPuzzle = new WeakMap(), _a4);
var _freshListenerManager3, _cachedScene, _currentTwisty2DPuzzleWrapper, _a5;
var Twisty2DSceneWrapper = (_a5 = class extends ManagedCustomElement {
  constructor(model, effectiveVisualization) {
    ...
    __privateAdd(this, _currentTwisty2DPuzzleWrapper);
    this.model = model;
    this.effectiveVisualization = effectiveVisualization;
  }
  disconnect() {
  ...
  async scene() {
    return __privateGet(this, _cachedScene) ?? __privateSet(this, _cachedScene, (async () => new (await bulk3DCode()).ThreeScene())());
  }
  scheduleRender() {
    var _a17;
...
}, _freshListenerManager3 = new WeakMap(), _cachedScene = new WeakMap(), _currentTwisty2DPuzzleWrapper = new WeakMap(), _a5);
...
var Twisty3DSceneWrapper = (_a8 = class extends ManagedCustomElement {
  ...
  async scene() {
    return __privateGet(this, _cachedScene2) ?? __privateSet(this, _cachedScene2, (async () => new (await bulk3DCode()).ThreeScene())());
  }
  addVantage(vantage) {
...
var SimultaneousMoveIndexer = class {
  ...
  constructor(kpuzzle, alg, options) {
    ...
    this.kpuzzle = kpuzzle;
    this.animLeaves = (options == null ? void 0 : options.animationTimelineLeaves) ?? simulMoves(alg);
  }
  getAnimLeaf(index) {
    var _a17;
...
async function loader() {
  return cachedLoader ?? (cachedLoader = new (await bulk3DCode()).ThreeTextureLoader());
}
...
var TwistyPlayerModel = class {
  constructor() {
     ...
     * ```
     */
    __publicField(this, "animationTimelineLeavesRequest", new AnimationTimelineLeavesRequestProp());
    /******************************** Depth 1 ********************************/
...
function waitForIntersection(player) {
  cachedSharedIntersectionObserver ?? (cachedSharedIntersectionObserver = new IntersectionObserver(
    (entries, observer) => {
...
var _textarea, _carbonCopy, _carbonCopyPrefix, _carbonCopyHighlight, _carbonCopySuffix, _textareaClassListValidForPuzzleManager, _twistyPlayer, _twistyPlayerProp, _TwistyAlgEditor_instances, algProp_get, _onInputHasFired, padSuffix_fn, _highlightedLeaf, _a14;
var TwistyAlgEditor = (_a14 = class extends ManagedCustomElement {
  constructor(options) {
    super();
  ...
  highlightLeaf(leaf) {
    ...
    __privateGet(this, _carbonCopySuffix).textContent = __privateMethod(this, _TwistyAlgEditor_instances, padSuffix_fn).call(this, __privateGet(this, _textarea).value.slice(leaf[endCharIndexKey]));
  ...
  set twistyPlayer(twistyPlayer) {
    ...
    if (__privateGet(this, _twistyPlayerProp) === "alg") {
      (_a17 = __privateGet(this, _twistyPlayer)) == null ? void 0 : _a17.experimentalModel.puzzleAlg.addFreshListener(
        (algWithIssues) => {
...
}, _textarea = new WeakMap(), _carbonCopy = new WeakMap(), _carbonCopyPrefix = new WeakMap(), _carbonCopyHighlight = new WeakMap(), _carbonCopySuffix = new WeakMap(), _textareaClassListValidForPuzzleManager = new WeakMap(), _twistyPlayer = new WeakMap(), _twistyPlayerProp = new WeakMap(), _TwistyAlgEditor_instances = new WeakSet(), algProp_get = function() {
...
padSuffix_fn = function(s) {
  return s.endsWith("\n") ? `${s} ` : s;
}, _highlightedLeaf = new WeakMap(), _a14);
...
var _domTree, _twistyPlayer2, _TwistyAlgViewer_instances, setTwistyPlayer_fn, _a15;
var TwistyAlgViewer = (_a15 = class extends HTMLElementShim {
  constructor(options) {
    super();
  ...
  async jumpToIndex(index, offsetIntoMove) {
    const twistyPlayer = __privateGet(this, _twistyPlayer2);
    if (twistyPlayer) {
      twistyPlayer.pause();
...
}, _domTree = new WeakMap(), _twistyPlayer2 = new WeakMap(), _TwistyAlgViewer_instances = new WeakSet(), setTwistyPlayer_fn = async function(twistyPlayer) {
  ...
  __privateGet(this, _twistyPlayer2).experimentalModel.alg.addFreshListener(
    (algWithIssues) => {
      this.setAlg(algWithIssues.alg);
    }
  );
  const sourceAlg = (await __privateGet(this, _twistyPlayer2).experimentalModel.alg.get()).alg;
  ...
  async connectedCallback() {
    ...
    if (["/edit/", "/explore/"].includes(pathname)) {
      ...
      if (config.puzzle && !(config.puzzle in puzzles)) {
        const puzzleDescription = (await import("./puzzle-geometry-HJS5QUYL.js")).getPuzzleDescriptionString(config.puzzle);
