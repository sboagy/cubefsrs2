...
// node_modules/cubing/dist/lib/cubing/chunks/twisty-dynamic-3d-OY64TJYU.js
...
var _setSpriteURL, _setHintSpriteURL, _sharedHintStickerGeometryCache, _Cube3D_instances, sharedHintStickerGeometry_fn, animateRaiseHintFacelets_fn, _a;
var Cube3D = (_a = class extends Object3D {
  constructor(kpuzzle, scheduleRenderCallback, options = {}) {
    ...
    __privateAdd(this, _setSpriteURL);
    __publicField(this, "sprite", new Promise((resolve) => {
      __privateSet(this, _setSpriteURL, (url) => {
        svgLoader.load(url, resolve);
      });
    }));
    __privateAdd(this, _setHintSpriteURL);
    __publicField(this, "hintSprite", new Promise((resolve) => {
      __privateSet(this, _setHintSpriteURL, (url) => {
        svgLoader.load(url, resolve);
      });
    }));
  ...
  experimentalSetStickerSpriteURL(stickerSpriteURL) {
    var _a3;
    (_a3 = __privateGet(this, _setSpriteURL)) == null ? void 0 : _a3.call(this, stickerSpriteURL);
  }
  // Can only be called once.
  /** @deprecated */
  experimentalSetHintStickerSpriteURL(hintStickerSpriteURL) {
    var _a3;
    (_a3 = __privateGet(this, _setHintSpriteURL)) == null ? void 0 : _a3.call(this, hintStickerSpriteURL);
  }
...
}, _setSpriteURL = new WeakMap(), _setHintSpriteURL = new WeakMap(), _sharedHintStickerGeometryCache = new WeakMap(), _Cube3D_instances = new WeakSet(), sharedHintStickerGeometry_fn = function() {
...
var PG3D = (_a2 = class extends Object3D {
  ...
  onPositionChange(p) {
    ...
    if (!this.lastPos || __privateGet(this, _pendingStickeringUpdate) || !this.lastPos.pattern.isIdentical(pattern)) {
...
var Twisty3DScene = class {
  constructor() {
    ...
    __publicField(this, "threeJSScene", (async () => new (await bulk3DCode()).ThreeScene())());
  }
...
//# sourceMappingURL=twisty-dynamic-3d-OY64TJYU-PWEWDQWL.js.map
